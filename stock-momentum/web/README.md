...
| Candlestick chart | `bot/samples_1m.csv`, one 1-min OHLC bar for the live account (`pulse.py` samples every ~10s); bucketed up to the chosen timeframe on read. No older data is folded in -- the chart starts where clean sampling started. |
