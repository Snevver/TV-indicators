...
import { createChart, LineStyle, CandlestickSeries, TickMarkType }
...
function render() {
  ...
  if (bars.length) {
    ...
    // (timeframe switch, where the bar count jumps). A routine poll adds one
    // bar and must not touch the user's zoom/pan.
